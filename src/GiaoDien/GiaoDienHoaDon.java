...
public class GiaoDienHoaDon extends javax.swing.JFrame {
  ...
  private DefaultTableModel myTable3;
    public GiaoDienHoaDon() {
        ...
        insertMaPD();
        insertMaNV();
        txtPhieuDat.setSelectedItem(null);
    ...
    private void initComponents() {
        ...
        txtPhieuDat = new javax.swing.JComboBox<>();
                        ...
                        .addGroup(pnl_TTCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(pnl_TTCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(pnl_TTCTLayout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(txtPhieuDat, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(pnl_TTCTLayout.createSequentialGroup()
        ...
        pnl_TTCTLayout.setVerticalGroup(
            ...
            .addGroup(pnl_TTCTLayout.createSequentialGroup()
                ...
                .addGroup(pnl_TTCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnl_TTCTLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel4)
                        .addComponent(txtPhieuDat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (txtMHD.getText().equals("") || txtMSTHD.getText().equals("") || txtMaNV.getSelectedItem().equals(null) || txtPhieuDat.getSelectedItem().equals(null) || dateBan.getDate().equals("")) {
            ...
            for (CT_PhieuDat ctpd : Controller.controller.arrayListCT_PhieuDat) {
                if (ctpd.getMaPD().equals(txtPhieuDat.getSelectedItem())) {
                    Gia = ctpd.getGia();
            ...
            BigDecimal T = new BigDecimal(Tien(txtPhieuDat.getSelectedItem().toString()));
            String MaNV = (String) txtMaNV.getSelectedItem();
            String MaPD1 = (String) txtPhieuDat.getSelectedItem();
            HoaDon hd = new HoaDon(txtMHD.getText(), MaNV, MaPD1, txtMSTHD.getText(),T, dateBan.getDate());
    ...
    private void jTable1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MousePressed
        ...
        txtPhieuDat.setSelectedItem((String) jTable1.getValueAt(row, 2));
        ...
        txtMaNV.setSelectedItem((String) jTable1.getValueAt(row, 6));
...
// TODO add your handling code here:
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (txtMHD.getText().equals("") || txtMSTHD.getText().equals("") || txtMaNV.getSelectedItem().equals(null) || txtPhieuDat.getSelectedItem().equals(null) || dateBan.getDate().equals("")) {
            ...
            Gia = new BigDecimal(Tien(txtPhieuDat.getSelectedItem().toString()));
            String MSTHD = (String) jTable1.getValueAt(row, 3);
            String MaNV = (String) txtMaNV.getSelectedItem();
            String MaPD1 = (String) txtPhieuDat.getSelectedItem();
            HoaDon hd = new HoaDon(txtMHD.getText(), MaNV, MaPD1, txtMSTHD.getText(), Gia, dateBan.getDate());
            for (HoaDon hdd : Controller.controller.arrayListHoaDon) {
...
// TODO add your handling code here:
    ...
    public javax.swing.JComboBox<String> txtPhieuDat;
